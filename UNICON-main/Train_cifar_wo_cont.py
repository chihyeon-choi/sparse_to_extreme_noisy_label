...
model_save_loc = 'checkpoint_noisy_label_wo_cont/{}_{}_{}_{}'.format(args.dataset, args.noise_mode, args.r, args.seed)
...
loader = dataloader.cifar_dataloader(args.dataset, r=args.r, noise_mode=args.noise_mode,batch_size=args.batch_size,num_workers=4,\
    root_dir=args.data_path,log=stats_log, seed=args.seed, noise_file='noise_file/%s_%s_%.1f_%d.npz'%(args.dataset, args.noise_mode, args.r, args.seed), root_dir_save='./clean_index_wo_cont')
